  ...
  "1": {
    ...
    revenue: {
      ...
      breakdown: [
        ...
        { label: "Tax", amount: 462, color: "bg-primary", percentage: 25.0 },
        {
          label: "Commission",
          amount: 370,
          color: "bg-accent",
  ...
  "2": {
    ...
    revenue: {
      ...
      breakdown: [
        ...
        { label: "Tax", amount: 355, color: "bg-primary", percentage: 25.0 },
        {
          label: "Commission",
          amount: 284,
          color: "bg-accent",
  ...
  "3": {
    ...
    revenue: {
      ...
      breakdown: [
        ...
        { label: "Tax", amount: 243, color: "bg-primary", percentage: 25.6 },
        {
          label: "Commission",
          amount: 190,
          color: "bg-accent",
