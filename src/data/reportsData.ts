// Store-specific reports data for Lily Hall Pensacola venues
export const reportsData = {
  ...
  '1': { // Brother Fox
    ...
    revenue: {
      ...
      growth: 5.8,
      breakdown: [
        { label: 'Net Revenue', amount: 845, color: 'bg-emerald-500', percentage: 45.7 },
        { label: 'Tax', amount: 462, color: 'bg-blue-500', percentage: 25.0 },
        { label: 'Commission', amount: 370, color: 'bg-orange-500', percentage: 20.0 },
  ...
  '2': { // Sister Hen
    ...
    revenue: {
      ...
      growth: 3.2,
      breakdown: [
        { label: 'Net Revenue', amount: 650, color: 'bg-emerald-500', percentage: 45.8 },
        { label: 'Tax', amount: 355, color: 'bg-blue-500', percentage: 25.0 },
        { label: 'Commission', amount: 284, color: 'bg-orange-500', percentage: 20.0 },
  ...
  '3': { // Cousin Wolf
    ...
    revenue: {
      ...
      growth: 2.9,
      breakdown: [
        { label: 'Net Revenue', amount: 433, color: 'bg-emerald-500', percentage: 45.6 },
        { label: 'Tax', amount: 243, color: 'bg-blue-500', percentage: 25.6 },
        { label: 'Commission', amount: 190, color: 'bg-orange-500', percentage: 20.0 },
