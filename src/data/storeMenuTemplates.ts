...
// Windrose Restaurant - Wood-fired hearth restaurant
const brotherFoxMenu: StoreMenuTemplate = {
  storeId: "1",
  storeName: "Windrose Restaurant",
  menuName: "Wood-Fired American Cuisine",
  description:
    "Contemporary shared plates and seafood from our wood-fired hearth.",
  categories: [
    {
      id: "snacks",
      ...
      items: [
        {
          ...
          name: "Pan Con Tomate",
          description:
            "Grilled bread with fresh tomato, olive oil, and sea salt",
          price: 8.0,
          modifierGroups: [],
        },
        {
        ...
        },
        {
          ...
          description:
            "Fresh Gulf snapper with citrus, jalapeño, and tortilla chips",
          price: 16.0,
          modifierGroups: ["spice-levels"],
        },
        {
          ...
          description:
            "Wine-soaked goat cheese with honey, marcona almonds, and crostini",
          price: 14.0,
          modifierGroups: [],
        },
      ],
      ...
      items: [
        {
          ...
          description:
            "Selection of cured meats, aged cheeses, pickled vegetables, and accompaniments",
          price: 32.0,
          modifierGroups: [],
        },
        {
          ...
          description:
            "Hearth-smoked mushrooms with capers, shallots, and toast points",
          price: 15.0,
          modifierGroups: [],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: "The Wedge",
          description:
            "Iceberg lettuce, blue cheese crumbles, bacon, and cherry tomatoes",
          price: 14.0,
          modifierGroups: [],
        },
      ],
      ...
      items: [
        {
          ...
          description:
            "Tender octopus with romesco sauce, fingerling potatoes, and charred lemon",
          price: 26.0,
          modifierGroups: [],
        },
        {
          ...
          description:
            "Wood-fired skirt steak with chimichurri and roasted vegetables",
          price: 38.0,
        ...
        },
        {
          ...
          name: "Seafood Paella",
          description:
            "Saffron rice with mussels, clams, shrimp, and chorizo (serves 2)",
          price: 56.0,
          modifierGroups: [],
        },
        {
          ...
          description:
            "Bone-in pork chop with apple mostarda and roasted root vegetables",
          price: 34.0,
          modifierGroups: ["cooking-styles"],
        },
        {
          ...
          description:
            "Daily catch, wood-fired with herbs, lemon, and olive oil",
          price: 42.0,
          modifierGroups: [],
        },
      ],
  ...
  categories: [
    {
      ...
      items: [
        {
          id: "tiki-bar-old-fashioned",
          name: "Tiki Bar Old Fashioned",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Cheese Plate",
          description:
            "Selection of artisan cheeses with honeycomb and crackers",
          price: 18.0,
          modifierGroups: [],
        },
      ],
...
// Salty Rose Beach Bar - Breakfast food truck
      ...
      items: [
        {
          ...
          name: "The Wolf",
          description:
            "Scrambled eggs, bacon, cheddar, and chipotle aioli on brioche",
          price: 10.0,
        ...
        },
        {
          ...
          name: "Veggie Wolf",
          description:
            "Scrambled eggs, avocado, tomato, and swiss on sourdough",
          price: 9.0,
          modifierGroups: ["egg-styles"],
        },
        {
          ...
          description:
            "House-made sausage patty with egg and cheese on buttermilk biscuit",
          price: 8.0,
          modifierGroups: ["egg-styles"],
        },
      ],
      ...
      items: [
        {
          ...
          description:
            "Scrambled eggs with chorizo, queso fresco, and salsa verde",
          price: 5.0,
          modifierGroups: ["spice-levels"],
        },
        {
        ...
        },
        {
          ...
          name: "Migas Taco",
          description:
            "Eggs scrambled with tortilla strips, peppers, and pico de gallo",
          price: 5.0,
          modifierGroups: ["spice-levels"],
        },
      ],
...
export const getAllStoreMenus = (): StoreMenuTemplate[] => {
  return Object.values(storeMenuTemplates).filter(
    (menu) => menu.storeId !== "default",
  );
};
