    ...
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        {statCards.map((card, index) => (
          ...
          >
            <Card
              className={`bg-gradient-to-br ${card.gradient} ${card.borderColor} shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden relative group`}
            >
              ...
              <CardContent className="p-4 relative z-10">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={`text-2xl font-bold ${card.textColor.replace("600", "900")}`}
                    >
                      <AnimatedCounter
                        value={card.value}
                        prefix={card.prefix}
                    ...
                    {card.growth !== null ? (
                      ...
                      >
                        <TrendingUp className="w-3 h-3" />+{card.growth}% from
                        last month
                      </motion.p>
                    ) : (
        ...
        <Card className="w-full shadow-lg hover:shadow-xl transition-all duration-300">
          <CardHeader className="pb-4">
            ...
            <p className="text-sm text-gray-600">
              Track how customers interact with your marketing campaigns
            </p>
          </CardHeader>
