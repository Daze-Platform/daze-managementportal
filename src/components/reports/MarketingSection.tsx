...
export const MarketingSection = () => {
  ...
  const campaigns = [
    { name: 'Brother Fox Specials', orders: 127, revenue: '$2,340', performance: 'excellent', color: 'bg-green-100 text-green-800' },
    { name: 'Speakeasy Happy Hour', orders: 89, revenue: '$1,567', performance: 'good', color: 'bg-blue-100 text-blue-800' },
    { name: 'Weekend Brunch', orders: 203, revenue: '$4,821', performance: 'outstanding', color: 'bg-purple-100 text-purple-800' }
  ];
        ...
        <CardContent className="space-y-6 relative z-10">
          ...
          >
            ...
            <div className="text-xs text-green-700">
              Weekend Brunch campaign shows highest ROI. Consider expanding similar promotions.
            </div>
          </motion.div>
        </CardContent>
      </Card>
