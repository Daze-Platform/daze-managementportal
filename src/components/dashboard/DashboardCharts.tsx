...
export const DashboardCharts = ({ storeName, revenueData, orderData, topItems }: DashboardChartsProps) => {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 lg:gap-6">
      {/* Revenue Chart */}
      <Card className="xl:col-span-2 shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      {/* Orders Chart */}
      <Card className="xl:col-span-3 shadow-sm hover:shadow-md transition-shadow duration-200">
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
