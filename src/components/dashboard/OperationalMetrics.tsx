...
import { TrendingUp, TrendingDown, Activity, Timer, Target, AlertTriangle } from 'lucide-react';
      ...
      <CardContent className="pb-6">
                  ...
                  <div className="w-16 h-2 bg-gray-200 rounded-full">
                    <div 
                      className={`h-2 rounded-full ${
                        metric.trend === 'good' ? 'bg-green-500' : 'bg-orange-500'
                      }`}
                      style={{ 
                        width: `${
                          metric.label === 'Order Accuracy' ? 96
                          : metric.label === 'Avg Prep Time' ? Math.max(100 - data.avgOrderPrepTime * 3, 25)
                          : metric.label === 'Peak Hour Orders' ? 87
                          : metric.label === 'Order Cancellations' ? 93
                          : 80
                        }%` 
                      }}
                    />
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-semibold text-blue-800 mb-1">Today's Performance</div>
