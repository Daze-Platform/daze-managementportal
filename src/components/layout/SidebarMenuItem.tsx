      ...
      <li className="relative">
        <div>
          <button
            ...
            className={`relative w-full flex items-center justify-between py-3 sm:py-3.5 md:py-4 rounded-xl text-sm sm:text-base font-medium transition-all duration-200 group touch-manipulation ${
              isActivePath
                ? isCollapsed
                  ? "text-white"
                  : "bg-white/16 text-white border border-white/20 shadow-md"
                : isCollapsed
            ...
            >
              {isCollapsed ? (
                <span className="relative inline-flex ml-[-1px]">
                  ...
                  />
                  <item.icon
                    className={`${item.iconClass} w-5 h-5 md:w-6 md:h-6 transition-transform group-hover:scale-110 flex-shrink-0 relative z-[1]`}
                  />
                </span>
              ) : (
                <item.icon
                  className={`${item.iconClass} w-5 h-5 md:w-6 md:h-6 transition-transform group-hover:scale-110 flex-shrink-0`}
                />
              )}
              {!isCollapsed && (
                <>
  ...
  return (
    <li>
      <NavLink
        to={item.path}
        className={({ isActive }) =>
          `relative flex items-center py-3 sm:py-3.5 md:py-4 rounded-xl text-sm sm:text-base font-medium transition-all duration-200 group touch-manipulation ${
            isActive
              ? isCollapsed
                ? "text-white"
                : "bg-white/16 text-white border border-white/20 shadow-md"
