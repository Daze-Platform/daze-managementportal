  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-blue-50 text-blue-900 font-semibold border-2 border-blue-200",
        day_outside:
      ...
      components={{
        IconLeft: ({ ..._props }) => <ChevronLeft className="h-5 w-5 sm:h-4 sm:w-4 text-gray-600" />,
        IconRight: ({ ..._props }) => <ChevronRight className="h-5 w-5 sm:h-4 sm:w-4 text-gray-600" />,
      }}
      {...props}
    />
  );
