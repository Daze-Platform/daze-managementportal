        ...
        <CardHeader className="pb-4 bg-gradient-to-br from-info/5 via-transparent to-transparent">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <Badge variant="secondary" className="bg-success/10 text-success border-0 px-3 py-1.5">
        ...
        <CardContent className="p-0">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/30 border-border/50">
                  ...
                  <TableHead className="font-semibold text-foreground">Review & Rating</TableHead>
                      ...
                      <div className="space-y-2 max-w-lg">
                        ...
                        {reviewReplies[index] && (
                          <div className="mt-3 p-3 bg-primary/5 border-l-2 border-primary rounded-r-lg">
                            ...
                            <p className="text-sm text-foreground">{reviewReplies[index]}</p>
                          </div>
                        )}
                      </div>
                    </TableCell>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-foreground">{review.customer}</div>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-semibold text-foreground mb-1">Review Insights</div>
                <p className="text-sm text-muted-foreground">
                  Recent feedback shows consistent quality expectations.{' '}
                  <span className="font-medium text-foreground">Response rate: 85% within 24 hours.</span>
                </p>
              </div>
            </div>
          </motion.div>
