...
export const StoreLogo = ({ 
  ...
  const variantClasses = {
    ...
    sleek: 'border border-gray-100 shadow-md ring-1 ring-black/5 backdrop-blur-sm',
...
export const LogoFrame: React.FC<LogoFrameProps> = ({
  ...
  const variantStyles = {
    ...
    sleek: 'bg-gradient-to-br from-white to-gray-50 border border-gray-100 shadow-md ring-1 ring-black/5',
  ...
  return (
    ...
    >
      {showImage ? (
        ...
        fallbackIcon || <Store className={cn(iconSizes[size], 'text-gray-400')} />
      )}
    </div>
  );
};
