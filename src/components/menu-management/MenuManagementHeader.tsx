      ...
      <div className="flex-shrink-0">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              className={`flex items-center space-x-2 sm:space-x-3 px-3 py-2 h-auto bg-white/90 backdrop-blur border border-gray-200 rounded-lg shadow-sm hover:shadow-md hover:bg-primary/10 hover:border-primary/30 transition-all duration-200 w-full justify-between ${
                isMobile ? "min-h-[40px]" : "min-h-[44px]"
              }`}
            >
              <div className="flex items-center space-x-2">
                <div className="text-left min-w-0 flex-1">
                  <div className="font-medium text-gray-900 text-sm hover:text-primary transition-colors duration-200 truncate">
                    {selectedStore.name}
                  </div>
          ...
          >
            ...
            {stores.map((store) => (
              <DropdownMenuItem
                ...
                className={`rounded-md p-3 cursor-pointer transition-all duration-200 hover:bg-primary/10 hover:border-primary/20 ${
