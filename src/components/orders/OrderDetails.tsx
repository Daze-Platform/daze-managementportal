...
export const OrderDetails = ({
  ...
  const getOrderItems = () => {
    const orderValue = parseFloat(selectedOrder) || 32.5;
  ...
  const selectedOrderDetails = {
    ...
    orderTime: "11:26 AM",
    specialInstructions:
      "Please make sure food is hot and include extra napkins. Customer has food allergies - no nuts.",
  };
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Sticky Header */}
      <div className="sticky top-0 z-20 bg-background border-b border-border p-4 flex-shrink-0">
          ...
          <div className="animate-fade-in min-w-0 flex-1">
            ...
            <div className="flex items-center space-x-2 mt-1">
              ...
              <span className="text-xs text-gray-500 truncate">
                Ordered at {selectedOrderDetails.orderTime}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2 mb-3">
          <Button
            ...
            onClick={() =>
              window.open(`tel:${selectedOrderDetails.customer.tel}`)
            }
          >
      ...
      {/* Scrollable Content */}
      <div
        className="flex-1 overflow-y-auto scroll-smooth overscroll-contain touch-pan-y p-4 space-y-4 pb-6"
          ...
          <CardContent className="p-3">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-1 min-w-0 flex-1">
                  ...
                  <span className="text-gray-900">
                    {selectedOrderDetails.customer.tel}
                  </span>
                </div>
                <Button
                  variant="ghost"
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-gray-900">
                  {selectedOrderDetails.customer.paymentMethod}
                </span>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-3">
            ...
            <div className="space-y-2 text-xs">
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center space-x-1">
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(
                          selectedOrderDetails.delivery.address,
                          "Address",
                        )
                      }
              ...
              <div>
                ...
                <div className="text-gray-900 mt-1 break-words">
                  {selectedOrderDetails.delivery.deliveryInstructions}
                </div>
              </div>
        ...
        <Card className="animate-fade-in">
          <CardContent className="p-3">
            <h3 className="font-semibold mb-2 text-sm">
              Order Items ({selectedOrderDetails.order.length} items)
            </h3>
            <div className="space-y-3">
              {selectedOrderDetails.order.map((item, index) => (
                <div
                  key={index}
                  className="flex items-start justify-between p-3 bg-gray-50 rounded-lg transition-all duration-200 hover:bg-gray-100 border border-gray-200"
                >
                  <div className="flex items-start space-x-2 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div
                        className={`font-semibold text-xs break-words transition-all duration-200 ${completedItems[index] ? "line-through text-gray-500" : "text-gray-900"}`}
                      >
                        {item.name}
                      </div>
                  ...
                  <span className="font-bold text-gray-900 text-xs flex-shrink-0 ml-2">
                    {item.price}
                  </span>
                </div>
              ))}
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between transition-colors duration-200 hover:bg-gray-50 p-1 rounded">
                ...
                <span className="text-gray-900">
                  {selectedOrderDetails.processingFee}
                </span>
              </div>
              <div className="flex justify-between transition-colors duration-200 hover:bg-gray-50 p-1 rounded">
                <span className="text-gray-600">Platform Fee</span>
                <span className="text-gray-900">
                  {selectedOrderDetails.platformFee}
                </span>
              </div>
              <div className="flex justify-between transition-colors duration-200 hover:bg-gray-50 p-1 rounded">
                <span className="text-gray-600">Delivery Tips</span>
                <span className="text-gray-900">
                  {selectedOrderDetails.deliveryTips}
                </span>
              </div>
