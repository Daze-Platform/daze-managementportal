...
export const OrderCardInfo = ({ order, activeTab }: OrderCardInfoProps) => {
  ...
  return (
    <>
      ...
      {/* Courier Info */}
      {(activeTab === 'ready' || activeTab === 'fulfillment') && order.courier && order.type === 'Delivery' && (
        <div className="mb-3">
          <Badge variant="outline" className="text-xs bg-purple-50 text-purple-700 border-purple-200 flex items-center space-x-1 w-fit">
