...
export const OrderCardActions = ({ order, activeTab, onOrderUpdate, onViewDetails }: OrderCardActionsProps) => {
  const handleButtonClick = (e: React.MouseEvent, action: 'accept' | 'decline' | 'ready' | 'complete' | 'fulfill' | 'schedule' | 'activate') => {
    e.stopPropagation();
      ...
      <div className="space-y-2.5 relative z-10">
        ...
        {activeTab === 'ready' && (
          <Button 
            ...
            onClick={order.type === 'Delivery' ? handleDeliveryHandoff : handlePickupComplete}
          >
            {order.type === 'Delivery' ? (
              <>
