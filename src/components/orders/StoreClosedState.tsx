...
export const StoreClosedState = ({
  ...
  return (
    <div
      className="min-h-screen flex items-start justify-center bg-gray-50 p-4 pt-[20vh] overflow-y-auto scroll-smooth"
      ...
      <div className="w-full max-w-sm sm:max-w-md mx-auto">
        <Card className="shadow-xl border-0 bg-white">
          <CardContent className="p-6 sm:p-8 text-center">
            <div className="mb-6">
              <div
                className={`w-16 h-16 sm:w-20 sm:h-20 bg-${displayInfo.statusColor === "red" ? "red" : "orange"}-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6`}
              >
                <IconComponent
                  className={`w-8 h-8 sm:w-10 sm:h-10 text-${displayInfo.statusColor === "red" ? "red" : "orange"}-600`}
                />
              </div>
              ...
              <div
                className={`flex items-center justify-center space-x-2 text-xs sm:text-sm text-gray-500 mb-6 sm:mb-8 bg-${displayInfo.statusColor === "red" ? "red" : "orange"}-50 rounded-lg py-2 sm:py-3 px-3 sm:px-4 mx-2`}
              >
                <div
                  className={`w-2 h-2 bg-${displayInfo.statusColor === "red" ? "red" : "orange"}-500 rounded-full animate-pulse flex-shrink-0`}
                ></div>
