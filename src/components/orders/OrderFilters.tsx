      ...
      <div className="flex flex-col space-y-2.5 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
        ...
        <div className="sm:hidden">
          <div className="flex items-center gap-2 overflow-x-auto py-1">
            ...
            >
              <Store
                className={`w-4 h-4 ${orderType === "pickup" ? "text-primary-foreground" : "text-foreground/80"}`}
              />
            ...
            >
              <Utensils
                className={`${orderType === "delivery" ? "text-primary-foreground" : "text-foreground/80"}`}
                size={16}
              />
        ...
        <Tabs
          value={orderType}
          onValueChange={(value) =>
            onOrderTypeChange(value as "all" | "pickup" | "delivery")
          }
