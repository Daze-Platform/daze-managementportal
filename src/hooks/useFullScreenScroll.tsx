...
export const useFullScreenScroll = () => {
  ...
  const updateScrollDirection = useCallback(() => {
    ...
    console.log(`Scroll direction: ${shouldHideUI ? 'hiding UI' : 'showing UI'}, scrollY: ${scrollY}`);
  }, [lastScrollY]);
  ...
  useEffect(() => {
    ...
    const handleViewportChange = () => {
      ...
      if (isMobile) {
        ...
        const scrollContainers = document.querySelectorAll('.mobile-scroll-container, .dashboard-scroll, .orders-scroll, .menu-scroll-container');
