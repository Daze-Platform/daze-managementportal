...
export const Employees = () => {
  ...
  const handleCreateUser = async (userData: { name: string; email: string; role: string; store: string; assigned_stores?: string[]; assigned_resorts?: string[]; status?: string; avatar?: string }) => {
    await addEmployee(
      {
        name: userData.name,
