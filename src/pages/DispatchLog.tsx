  ...
  <tr className="bg-muted/20">
    <td colSpan={6} className="px-4 py-3">
      <div className="space-y-2 text-xs font-mono">
        ...
        {row.chosenCourierId && (
          <div>
            <strong>Chosen courier:</strong> {row.chosenCourierId}
          </div>
        )}
        {row.errorMessage && (
      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Every dispatch decision, why it went the way it did. Last 100.
          </p>
        </div>
          ...
          <tbody className="divide-y divide-border">
            {rows.length === 0 && (
              <tr>
                ...
                >
                  No dispatch decisions yet. Once a tenant is in 'auto' or
                  'hybrid' mode and orders flow, they'll appear here in real
                  time.
                </td>
              </tr>
            )}
