  ...
  const handleEditPromotion = async (formData: any) => {
    if (editingPromotion) {
      ...
      > = {
        ...
        discount_value: parseFloat(formData.discount) || 0,
        start_date:
          formData.startDate?.toISOString() || editingPromotion.start_date,
                    ...
                    <div className="space-y-3">
                      ...
                      {promotion.store_id && (
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm">
                            {stores.find((s) => s.id === promotion.store_id)
                              ?.name || "Unknown"}
                          </span>
                        </div>
                      )}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-6">
                    {searchTerm
                      ...
                      : "Get started by creating your first promotion to boost your sales!"}
                  </p>
                  {!searchTerm && (
      ...
      >
        <DialogContent className="max-w-4xl h-[90vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto pr-2">
            <PromotionForm
              onSave={
                editingPromotion ? handleEditPromotion : handleCreatePromotion
              }
              initialData={
                editingPromotion
                  ? {
