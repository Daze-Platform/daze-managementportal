...
const ratingsData = {
  ...
  topRatedItems: [
    ...
    {
      name: "The Wolf Sandwich",
      rating: 4.8,
      reviews: 35,
      emoji: "🥪",
      venue: "Salty Rose Beach Bar",
    },
    {
      name: "Seafood Paella",
      rating: 4.7,
  ...
  recentReviews: [
    {
      ...
      rating: 5,
      review:
        "The Charbroiled Oysters at Windrose Restaurant were incredible! Perfectly seasoned with that herb butter and parmesan. Best oysters in Pensacola!",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "Tiki Bar's Old Fashioned is a masterpiece. The smoked cherry really elevates it. Such a cozy speakeasy vibe too!",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "Salty Rose Beach Bar's breakfast tacos are my new weekend ritual! The Chorizo & Egg Taco with that salsa verde is absolutely perfect.",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The Prime Skirt Steak Asada at Windrose Restaurant was cooked to perfection. That chimichurri sauce is incredible! Will definitely be back.",
    ...
    },
    {
      ...
      rating: 4,
      review:
        "Loved the Midnight Garden cocktail at Tiki Bar - that mezcal and jalapeño combo is unique! Would've given 5 stars but the wait was a bit long.",
    ...
    },
    {
      ...
      rating: 3,
      review:
        "Cold Brew from Salty Rose Beach Bar was good but arrived lukewarm. Would appreciate better temperature control for deliveries.",
